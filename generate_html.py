...
# path = "/Users/yw-zhang/Downloads/vis/20_cross_att_final"
# fname = "index.html"

# for file in os.listdir(path):
# 	html += f"<center><img src='{file}' ></center><br>"
...
path = "/Users/yw-zhang/Downloads/vis/20"
fname = "index.html"
...
for filename in filenames:
	html = ""
	html += f"<center><img src='../20_cross_att_layer/{filename}'/ width=100% ></center><br>"
	html += f"<center><img src='../20_cross_att_final/{filename}'/ width=100% ></center><br>"
	html += f"<center><img src='../20_cross_att_head/{filename}'/ width=100% ></center><br>"
