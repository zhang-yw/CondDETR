...
save_path = "/nobackup/yiwei/coco/images/vis/2_cross_att_final"
...
checkpoint = torch.load("/nobackup/yiwei/CondDETR/output/2queries_cross_attention+LearnableRef_conddetr_r50_epoch50/checkpoint0049.pth")
...
for fname in filenames:
    ...
    for idx, ax_i, (xmin, ymin, xmax, ymax) in zip(keep.nonzero(), axs.T, bboxes_scaled):
        ...
        ax.axis('off')
        softmax = ['{:.2f}'.format(x) for x in final_dec_attn_weights_idx]
